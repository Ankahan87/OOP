class Student:
    def __init__(self, name, surname, gender):
        ...
        self.grades = {}
    def __str__(self):
        return f"Имя: {self.name}/nФамилия: {self.surname}/nСредняя оценка за домашние задания: {self.make_average_grade()}/nКурсы в процессе изучения: "
        +",".join(self.courses_in_progress) + "/nЗавершенные курсы: "+",".join(self.finished_courses)
...
class Lecturer(Mentor):
    ...
    student_grades = {}
    def __str__(self):
        return f"Имя: {self.name}/nФамилия: {self.surname}/nСредняя оценка за лекции: {self.make_average_grade_lector()}"
